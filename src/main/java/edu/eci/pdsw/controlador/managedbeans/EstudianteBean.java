...
public class EstudianteBean {
    ...
    public void setMonitoria(String ip, String observaciones, Date fecha,  Tema tema, FranjaHorario franjaHorario, String profesor, int idC, int grupo,String asignatura) {
        this.monitoria = new Monitoria(ip,observaciones,fecha,tema,franjaHorario,profesor,idC,grupo,asignatura) ;
    }
